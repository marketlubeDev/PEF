...
const OverlappingCarousel = () => {
  ...
  function updateSlides(direction: "next" | "prev") {
    ...
    outgoingSlide?.classList.add(
      direction === "next" ? "transition-out" : "transition-in"
    );
            ...
            <div className="carousal-slide-outer">
              <div className="slide-content">
                <div className="testimonial-title mb-20">
                  <h2 className="slide-header mb-32">
                    See How Others Made It Happen.
                  </h2>
                  <p className="testimonial-para">
                    &quot;I was nervous about studying abroad, but their team
                    made it feel so easy. They guided me through every step —
                    from choosing the right university to securing my visa. Now
                    I&apos;m living my dream in Canada!&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="slide-form">
                ...
                <div className="profile-details">
                  <div className="detail-item">
                    ...
                    <div className="detail-value">Anjali Menon</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Abroad Choice</div>
                    <div className="detail-value">Canada</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="carousal-slide-outer">
              <div className="slide-content">
                <div className="testimonial-title mb-20">
                  ...
                  <p className="testimonial-para">
                    &quot;The application process seemed overwhelming at first,
                    but with their expert guidance, I was able to navigate it
                    smoothly. My experience studying in Australia has been
                    life-changing!&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="slide-form">
                ...
                <div className="profile-details">
                  <div className="detail-item">
                    <div className="detail-label">Name</div>
                    <div className="detail-value">Akshay Raj</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Abroad Choice</div>
                    <div className="detail-value">Australia</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="carousal-slide-outer">
              <div className="slide-content">
                <div className="testimonial-title mb-20">
                  ...
                  <p className="testimonial-para">
                    ...
                    They helped me find a program that perfectly matched my
                    career goals, and now I&apos;m thriving in my studies
                    abroad!&quot;
                  </p>
                </div>
              </div>
              ...
              <div className="slide-form">
                ...
                <div className="profile-details">
                  <div className="detail-item">
                    <div className="detail-label">Name</div>
                    <div className="detail-value">Arun Kumar</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Abroad Choice</div>
                    <div className="detail-value">United Kingdom</div>
                  </div>
                </div>
              </div>
            </div>
