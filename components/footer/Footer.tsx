            ...
            <div className="footer-column">
              ...
              <ul>
                ...
                <li className="address">
                  PRADEEPAM,
                  <br />
                  CO-OPERATIVE HOSPITAL ROAD,
                  <br />
                  VADAKARA, CALICUT
                </li>
                <li className="email">
                  <span>+91 8891 000 500</span>
                  <br />
                  <span>+91 9895 101 101</span>
                </li>
